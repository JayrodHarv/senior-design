...
## Can work on each step independently and then connect them together after they are done

## We will be using the PlatformIO extension in VSCode and writing most our code in C++.
